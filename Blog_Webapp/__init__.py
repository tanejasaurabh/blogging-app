...
client = MongoClient('mongodb://saurabhtaneja:Tanejar2351@ds125273.mlab.com:25273/project')
db = client['project']
...
def login():
	if request.method == 'POST':
		if request.form['username'] == 'saurabhtaneja' and request.form['password'] == 'hello':
			session['username'] = 'saurabhtaneja'
